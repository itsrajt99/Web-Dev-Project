...
const Cart = () => {
  const {products,navigate,cartCount
    ,totalCartAmount,cartItems,removeFromCart,updateCartItem} = useContext(AppContext);
    ...
    <div className="flex flex-col md:flex-row py-16 max-w-6xl w-full px-6 mx-auto">
            ...
            <div className="max-w-[360px] w-full bg-gray-100/40 p-5 max-md:mt-16 border border-gray-300/70">
                        ...
                        {showAddress && (
                            <div className="absolute top-12 py-1 bg-white border border-gray-300 text-sm w-full">
                               ...
                               <p onClick={()=>navigate("/add-address")}
                                className='text-indigo-500 text-center cursor-pointer p-2 
                                hover:bg-indigo-500/10'>Add Address</p>
                            </div>
                        )}
                    </div>
                ...
                <div className="text-gray-500 mt-4 space-y-2">
                    ...
                    <p className="flex justify-between">
                        <span>Tax (%)</span><span>${totalCartAmount() * 0.02}</span>
                    </p>
